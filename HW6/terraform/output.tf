output "internal_ip_address_vm_0" {
  value = yandex_compute_instance.pg-0.network_interface.0.ip_address
}
...
output "internal_ip_address_vm_3" {
  value = yandex_compute_instance.pg-3.network_interface.0.ip_address
}



output "external_ip_address_vm_0" {
  value = yandex_compute_instance.pg-0.network_interface.0.nat_ip_address
}
...
output "external_ip_address_vm_3" {
  value = yandex_compute_instance.pg-3.network_interface.0.nat_ip_address
}
