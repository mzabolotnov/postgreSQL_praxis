...
${int_ip_vm1} consul_node_role=server consul_bootstrap_expect=true consul_datacenter=dc1
${int_ip_vm2} consul_node_role=server consul_bootstrap_expect=true consul_datacenter=dc1
${int_ip_vm3} consul_node_role=server consul_bootstrap_expect=true consul_datacenter=dc1
...
# PostgreSQL nodes
[master]
${int_ip_vm1} hostname=pgnode01 postgresql_exists=false

[replica]
${int_ip_vm2} hostname=pgnode02 postgresql_exists=false
${int_ip_vm3} hostname=pgnode03 postgresql_exists=false
